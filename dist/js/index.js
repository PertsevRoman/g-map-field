...
Vue.component('path-input', {
    template: "<div class=\"map-container\" xmlns:v-on=\"http://www.w3.org/1999/xhtml\" xmlns:v-bind=\"http://www.w3.org/1999/xhtml\"><div class=\"g-maps\"></div><div class=\"controls\"><div class=\"row\"><ul class=\"list-group\"><li class=\"list-group-item\" v-for=\"(point, index) in currentPath.markers\" :key=\"point.coordsStr\"><div class=\"input-group\"> <input type=\"text\" v-model=\"point.description\"> <button v-on:click=\"remove(index)\" class=\"btn btn-default\">Удалить</button></div></li></ul></div></div> <input type=\"hidden\" v-bind:name=\"fieldName\" v-bind:value=\"currentPath.serial\"></div>",
