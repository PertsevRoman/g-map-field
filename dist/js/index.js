        ...
        try {
            var Prof = Vue.extend({
                ...
                updated: function updated() {
                    var size = this.currentPath.size;
                    var selector = 'input[date-time="dt-' + size + '"]';
