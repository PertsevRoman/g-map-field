                ...
                methods: {
                    ...
                    init: function init() {
                        ...
                        google.maps.event.addListener(this.map.map, 'click', function (event) {
                            ...
                            setTimeout(function () {
                                var selector = 'input[date-time="dt-' + elemPosition + '"]';
